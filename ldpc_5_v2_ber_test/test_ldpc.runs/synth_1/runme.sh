...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decode_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decode_exdes.tcl

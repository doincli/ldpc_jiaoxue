...
HD_PWD='C:/Users/doinc/Desktop/decode_final_test/ldpc_5_v2_error/test_ldpc.runs/fifo_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_ila.tcl

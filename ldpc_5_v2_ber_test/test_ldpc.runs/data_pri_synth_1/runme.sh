...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/data_pri_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_pri.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_pri.tcl

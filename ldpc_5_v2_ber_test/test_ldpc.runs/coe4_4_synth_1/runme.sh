...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/coe4_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coe4_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coe4_4.tcl

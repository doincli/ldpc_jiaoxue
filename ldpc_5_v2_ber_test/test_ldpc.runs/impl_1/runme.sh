...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decode_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decode_exdes.tcl -notrace

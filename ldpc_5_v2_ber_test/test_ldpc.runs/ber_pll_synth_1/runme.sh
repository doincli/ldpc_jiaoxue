...
HD_PWD='C:/Users/doinc/Desktop/decode_final_test/ldpc_5_v2/test_ldpc.runs/ber_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ber_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ber_pll.tcl

...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/H2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H2_1.tcl

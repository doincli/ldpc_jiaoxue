...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/H3_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H3_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H3_4.tcl

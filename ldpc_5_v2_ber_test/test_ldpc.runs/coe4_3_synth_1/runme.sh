...
HD_PWD='E:/ldpc_5_v2_ber_test/test_ldpc.runs/coe4_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coe4_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coe4_3.tcl

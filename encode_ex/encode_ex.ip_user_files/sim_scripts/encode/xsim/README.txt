...
#
# Generated by export_simulation on Tue Apr 09 14:43:05 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './encode.sh' script.
...
./encode.sh -noclean_files

For more information on the script, please type './encode.sh -help'.

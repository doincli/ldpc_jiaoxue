...
HD_PWD='E:/ldpc_jiaoxue/ldpc_jiaoxue/encode_ex/encode_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encode_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encode_exdes.tcl -notrace

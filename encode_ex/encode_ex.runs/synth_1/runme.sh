...
HD_PWD='E:/ldpc_jiaoxue/ldpc_jiaoxue/encode_ex/encode_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encode_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encode_exdes.tcl

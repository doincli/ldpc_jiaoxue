...
HD_PWD='E:/ldpc_jiaoxue/ldpc_jiaoxue/encode_ex/encode_ex.runs/rd_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rd_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rd_fifo.tcl

...
HD_PWD='E:/ldpc_jiaoxue/ldpc_jiaoxue/encode_ex/encode_ex.runs/H1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H1.tcl

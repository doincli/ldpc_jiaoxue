...
HD_PWD='E:/ldpc_jiaoxue/ldpc_jiaoxue/encode_ex/encode_ex.runs/H3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H3.tcl

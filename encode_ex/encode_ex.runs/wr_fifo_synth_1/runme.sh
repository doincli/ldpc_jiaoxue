...
HD_PWD='E:/ldpc_jiaoxue/ldpc_jiaoxue/encode_ex/encode_ex.runs/wr_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wr_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wr_fifo.tcl
